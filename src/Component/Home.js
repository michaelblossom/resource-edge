		...
		<div className="main-header">
			...
			<div className="vision">
				<div className="container">
					...
					<div className="mission">
						<p>
							Onboard new employees, managed the employee lifecycle and measure
					...
					<div className="side-bar">
						...
						<div className="grading">
							...
							<p>
								...
								for goal setting, performance agreements and performance
								reviews.
							</p>
						</div>
						<div className="grading">
			...
			<div className=" container section">
				...
				<div className="admin3">
					...
					<p>
						Mana the aquisition, assignment and disposition of assets seamlessly
					</p>
				</div>
			</div>
			...
			<div className=" container section">
				<div className="admin1">
					<h5>Finance</h5>
					<p>
						Generate invoice, track expenditure, and manage complex payrolls for
